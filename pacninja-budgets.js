...
// Pac Ninja Front-End (pacninja-fe) - Budgets
...
$(document).ready(function() {
    ...
    tableBudgets = $('#budgetsdetailtable').dataTable({
        ajax: {
            url: "/api/budgets?testnet=" + pacninjatestnet,
    ...
    tableBudgetsProjection = $('#budgetsprojectiondetailtable').dataTable({
        ajax: {
            url: "/api/budgetsprojection?testnet=" + pacninjatestnet,
    ...
    tableSuperBlocks = $('#superblockstable').dataTable({
        ajax: {
            url: "/api/blocks?testnet=" + pacninjatestnet + "&onlysuperblocks=1",
            dataSrc: 'data.blocks'
        },
        paging: false,
        order: [
    ...
    tableSuperBlocksExpected = $('#superblocksexpectedtable').dataTable({
        ajax: {
            url: "/api/budgetsexpected?testnet=" + pacninjatestnet,
