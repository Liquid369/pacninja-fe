...
// Pac Ninja Front-End (pacninja-fe) - Masternode List Classic (v2)
// By elberethzone / https://www.dash.org/forum/members/elbereth.175/

var pacninjaversion = '1.0.1';
...
$(document).ready(function() {
    ...
    if (pacninjatestnet == 1) {
        ...
        if (typeof pacninjatestnettor !== 'undefined') {
            $('a[name=pacninjatorurl]').attr("href", "http://"+pacninjatestnettor+"/masternodes-classic.html");
            $('span[name=pacninjatordisplay]').show();
        }

        if (typeof pacninjatestneti2p !== 'undefined') {
            $('a[name=pacninjai2purl]').attr("href", "http://" + pacninjatestneti2p + "/masternodes-classic.html");
            $('span[name=pacninjai2pdisplay]').show();
        }
    }
    else {
        if (typeof pacninjator !== 'undefined') {
            $('a[name=pacninjatorurl]').attr("href", "http://"+pacninjator+"/masternodes-classic.html");
            $('span[name=pacninjatordisplay]').show();
        }

        if (typeof pacninjai2p !== 'undefined') {
            $('a[name=pacninjai2purl]').attr("href", "http://" + pacninjai2p + "/masternodes-classic.html");
            $('span[name=pacninjai2pdisplay]').show();
        }
    }
    ...
    $('#mnlist').on('xhr.dt', function ( e, settings, json ) {
        ...
        for ( var i=0, ien=json.data.masternodes.length ; i<ien ; i++ ) {
            ...
            if ((json.data.masternodes[i].Portcheck != false) && json.data.masternodes[i].Portcheck.hasOwnProperty("SubVer")) {
                ...
                else if ((json.data.masternodes[i].Portcheck.SubVer.length > 11) && (json.data.masternodes[i].Portcheck.SubVer.substring(0,11) == '/Pac Core:') && (json.data.masternodes[i].Portcheck.SubVer.substring(json.data.masternodes[i].Portcheck.SubVer.length-1) == '/')) {
                ...
                if (type != 'sort') {
                    if ((pacninjamndetailvin[pacninjatestnet].length > 0) || (pacninjatxexplorer[pacninjatestnet].length > 0)) {
                        ...
                        for ( var i=0, ien=pacninjamndetailvin[pacninjatestnet].length ; i<ien ; i++ ) {
                            if (ix == 0) {
                                outtxt += '<a href="'+pacninjamndetailvin[pacninjatestnet][0][0].replace('%%a%%',data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex)+'" data-toggle="tooltip" data-placement="left" title="'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'">'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'</a>';
                            }
                            else {
                        ...
                        for ( var i=0, ien=pacninjatxexplorer[pacninjatestnet].length ; i<ien ; i++ ) {
                            if (ix == 0) {
                                outtxt += '<a href="'+pacninjatxexplorer[pacninjatestnet][0][0].replace('%%a%%',data.MasternodeOutputHash)+'" data-toggle="tooltip" data-placement="left" title="'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'">'+data.MasternodeOutputHash+'-'+data.MasternodeOutputIndex+'</a>';
                            }
                            else {
